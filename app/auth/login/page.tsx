      ...
      <div className="flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="mx-auto w-16 h-16 bg-gradient-to-br from-blue-600/30 to-blue-800/30 rounded-full flex items-center justify-center mb-4 backdrop-blur-sm border border-blue-500/20">
              <Lock className="w-8 h-8 text-blue-400" />
            </div>
            <h1 className="text-3xl font-light tracking-tight text-white mb-2">
              Ravi de vous <span className="font-semibold">revoir</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-3">
              {socialProviders.map((provider) => (
                <Button
                  ...
                  onClick={() =>
                    toast.info(`Connexion ${provider.name} bientôt disponible`)
                  }
                >
