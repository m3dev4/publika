                  ...
                  <div className={cn("flex w-full flex-col gap-1")}>
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <div className="flex items-center gap-2">
                            <p className="ml-2 text-sm font-medium">explorer</p>
                          </div>
                        )}
                      </motion.li>
                    </Link>
                    <Link
                      ...
                      className={cn(
                        ...
                        pathname?.includes("post") && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    >
                      ...
                      <motion.li variants={variants}>
                        {!isCollapsed && (
                          <p className="ml-2 text-sm font-medium">Annonces</p>
                        )}
                      </motion.li>
                    </Link>
                    <Link
